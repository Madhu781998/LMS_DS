...
# import Dataset 
anime = pd.read_csv("C:/Datasets_BA/360DigiTMG/DS_India/360DigiTMG DS India Module wise PPTs/Module 24 Recommendation Engine/dataset/anime.csv", encoding = 'utf8')
anime.shape # shape
anime.columns
