...
df = pd.read_csv("C:/Users/madhu/OneDrive/Desktop/360digiTMG/Data Science/13 Data Mining Unsupervised Learning - Association Rules/Hands-on Material/transactions_retail1.csv", header = None)
df.head()
